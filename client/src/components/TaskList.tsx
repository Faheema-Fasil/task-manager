              ...
              <div className="mb-4 p-4 bg-gray-50 rounded relative">
                <div className='flex items-center px-8 mr-50 justify-between mx-5'>
                  ...
                  <div className='flex bg-white  absolute  border border-gray-300 rounded-2xl p-2 text-sm items-start justify-items-start flex-col'>
                    ...
                    <button className=' w-full  text-start flex text-xs mb-1 flex items-start justify-items-start hover:border-b border-gray-300'>IN-PROGRESS</button>
                    <button className=' w-full text-start flex text-xs mb-1 flex items-start justify-items-start hover:border-b border-gray-300'>COMPLETED</button>
                  </div>
                  </div>
                  <div>
                  ...
                  <button className='border border-gray-300 rounded-full text-sm p-1'><FiPlus/></button>
                  <div className='flex bg-white  absolute border border-gray-300 rounded-2xl p-2 text-sm items-start justify-items-start flex-col'>
                    <button className=' w-text-start flex text-xs mb-1 flex items-start justify-items-start hover:border-b border-gray-300'>WORK</button>
                    <button className=' w-text-start flex text-xs mb-1 flex items-start justify-items-start hover:border-b border-gray-300'>PERSONAL</button>
