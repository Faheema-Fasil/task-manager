  ...
  return (
    <div className="flex justify-between items-center row mb-4">
      ...
      <div className="flex flex-col">
        ...
        <button onClick={handleLogout} className="border bg-purple-100 mt-2 border-purple-300 rounded-lg p-1 flex items-center hover:bg-purple-200 transition duration-200">
