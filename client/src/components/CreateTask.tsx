    ...
    return (
        ...
        >
            <div className="bg-white  rounded-3xl shadow-lg w-200  ">
                ...
                <div className=" p-6 snap-y mb-25">
                    ...
                    <input className="w-full py-1 bg-gray-50  border border-gray-300 rounded-md p-2 text-sm  focus:outline-none focus:ring-2 focus:ring-purple-500" placeholder=" Task title" type="text" />
                    {/* <textarea
      ...
      /> */}
                    ...
                    <div className="flex items-center gap-3 mt-2 justify-between  border-gray-300 ">
                        <div className="font-sm w-4/12 flex flex-col gap-2  text-gray-600">Task Category*
                            <div className="flex gap-2">
                                <button className="border border-gray-300 px-4 text-xs text-black py-1 rounded-full hover:bg-gray-200 transition duration-200">Work</button>
                                <button className="border border-gray-300 px-4 text-xs text-black py-1 rounded-full hover:bg-gray-200 transition duration-200">Personal</button>
                            </div>

                        </div>
                        <div className="font-sm w-4/12 flex flex-col gap-2 text-gray-600">Due on*
                        ...
                        <div className="font-sm w-4/12 flex flex-col gap-2  text-gray-600">Task Status*
                            <select className="border border-gray-300 text-gray-400 transition duration-200 w-full bg-gray-50
 hover:bg-gray-100  text-sm text-black py-1 rounded-full ">
                                <option value="" disabled selected hidden className=""> Choose</option>
                    ...
                    <div>
                        ...
                        <div className="border border-gray-300 rounded-md p-4 bg-gray-100 text-center relative"> {/* relative for absolute positioning of the input */}
                            <input
                                type="file"
                                ref={fileInputRef}
                                className="absolute opacity-0 pointer-events-none" // Hide the input visually
                ...
                <div className="mt-6 p-6 flex rounded-b-3xl border-t border-gray-400  bg-gray-200 justify-end gap-3">
                    ...
                    <button
                        onClick={() => {
                            console.log("Task Saved:", description);
                            onHide();
                        }}
