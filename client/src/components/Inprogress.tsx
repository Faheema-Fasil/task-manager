...
const Inprogress: React.FC<{ tasks: Task[]; updateTaskStatus: (id: string, status: Task["status"]) => void;  menuOpenTaskId: string | null ; setMenuOpenTaskId: React.Dispatch<React.SetStateAction<string | null>>;handleDelete: (id: string) => void; handleEdit: (id: string) => void }> = ({
  tasks,
  updateTaskStatus,
  menuOpenTaskId,
  setMenuOpenTaskId,
