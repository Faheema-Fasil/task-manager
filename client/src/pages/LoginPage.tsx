...
const LoginPage: React.FC = () => {
  ...
  return (
    <div className="flex w-full h-screen">
      ...
      <img className="absolute object-contain md:object-cover top-0 left-1/2 transform -translate-x-1/2 mt-6 mb-[-2rem]  " src="../src/assets/circles_bg.png" alt="" />
      <div className="flex items-center justify-center w-full">

        <img  className=" absolute object-contain md:object-cover right-0 top-10 h-165 w-145 border border-gray-200   rounded-xl shadow-lg " src={image} alt="" />
      </div>
      </div>
    </div>
  );
